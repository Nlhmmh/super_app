...
const CustomButton = React.forwardRef<View, Props>(function CustomButton(
  {
    title,
    onPress,
    variant = "primary",
  ...
  return (
    <TouchableOpacity
      ...
      style={[
        ...
        stretch ? { width: "100%" } : width ? { width: width } : undefined,
    ...
    >
      {loading ? (
        <ActivityIndicator
          ...
          color={variant === "primary" ? theme.text : theme.textTint}
        />
      ) : (
        <ThemedText
          type={textType}
